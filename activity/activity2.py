...
result_extract_phrase_programming_language = extract_phrase_programming_language(text)
...
print("3. Extracted phrase 'programming language':", result_extract_phrase_programming_language)
